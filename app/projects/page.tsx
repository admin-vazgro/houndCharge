...
const PROJECTS = [
  { id: 1,  name: "Hound Ares",        category: "Flagship Project",                   coverage: "Ernakulam Border Region",              status: "active", locations: 12, chargers: 80, group: "flagship",   motive: "Flagship charging corridor at the Ernakulam border ensuring seamless intercity EV mobility and high charger availability." },
